...
MAX_REVIEW_RETRIES=${MAX_REVIEW_RETRIES:-2}   # Review→fix cycles per wave
...
STALE_THRESHOLD=${STALE_THRESHOLD:-600}   # Seconds of inactivity before a worker is killed
                                          # This is the ONLY kill mechanism — no wall-clock timeout.
                                          # "Activity" = log output, child processes, or CPU usage.
